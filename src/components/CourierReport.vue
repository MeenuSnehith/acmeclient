          ...
          <section >
            <section class="pdf-item">
              ...
              <v-card class="mx-auto px-10 py-8" width="800px" height="150px">
                ...
                <v-row><h4>Number of Deliveries: </h4> &nbsp; <p>{{ cust.noofDeliveries }}</p></v-row>
                ...
                <v-row><h4>Total Payout: </h4> &nbsp; <p>{{ cust.payout }}</p></v-row>
              </v-card>
    ...
    methods: {
      ...
      processInvoice: function(deliveries){
        ...
        deliveries.forEach(element => {
          //status
          if(element.isBonus != null && element.isBonus == "yes"){
            tempBonus = "Yes"
          }
          else {
            tempBonus = "No"
        ...
        dueAmount = dueAmount + (bonusCount * 10)
        var invoice = {
